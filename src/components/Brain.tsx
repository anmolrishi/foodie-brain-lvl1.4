      ...
      <div className={`flex-grow p-8 transition-all duration-300 ${isNavbarExpanded ? 'ml-64' : 'ml-20'}`}>
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-3xl font-bold text-blue-900">Neural Network Interface</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h2 className="text-xl font-semibold text-gray-800">Neural Network Engineer</h2>
                      <Button
                        size="sm"
                        colorScheme="blue"
                        variant="ghost"
                  ...
                  <Box
                    ...
                    alignItems="center"
                  >
                    <h2 className="text-xl font-semibold text-gray-800 mb-8">Test Your Neural Network</h2>
                    <div
